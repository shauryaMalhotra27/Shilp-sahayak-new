      ...
      <div className="border-b border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <span>/</span>
            <span className="text-foreground font-medium">Pomodoro Device</span>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-8 space-y-16">
            {/* Gallery Placeholder */}
            <div className="aspect-video bg-muted rounded-2xl overflow-hidden border border-border flex items-center justify-center relative">
              <div className="w-64 h-64 bg-foreground/90 rounded-full flex items-center justify-center shadow-2xl relative">
                <div className="absolute inset-0 bg-gradient-to-tr from-warning/20 to-transparent rounded-full" />
                <div className="w-48 h-48 bg-foreground rounded-full flex items-center justify-center border-4 border-foreground/70">
                  <span className="text-4xl font-mono text-warning font-bold">
                    25:00
                  </span>
                </div>
                <div className="absolute -right-4 w-8 h-16 bg-foreground/80 rounded-r-lg" />{' '}
                {/* Knob */}
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div
                  ...
                  className="bg-muted p-6 rounded-xl border border-border">
                    ...
                    <div className="w-10 h-10 bg-card rounded-lg shadow-sm flex items-center justify-center mb-4 text-warning">
